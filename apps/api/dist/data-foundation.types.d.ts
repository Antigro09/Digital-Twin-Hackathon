...
export declare const DATA_FOUNDATION_SCHEMA_VERSION = "edt.data-foundation/1.0.0";
export declare const EVENT_CATEGORIES: readonly ["employee_change", "system_failure", "customer_change", "financial_change", "market_change", "operational_change"];
export type TwinEventCategory = (typeof EVENT_CATEGORIES)[number];
export declare const EVENT_SEVERITIES: readonly ["info", "low", "medium", "high", "critical"];
export type TwinEventSeverity = (typeof EVENT_SEVERITIES)[number];
export declare const EVENT_OUTCOMES: readonly ["observed", "mitigated", "resolved", "failed", "unknown"];
export type TwinEventOutcome = (typeof EVENT_OUTCOMES)[number];
export declare const DATA_PLANE_IDS: readonly ["application_data", "graph_data", "ai_knowledge", "historical_metrics"];
export type DataPlaneId = (typeof DATA_PLANE_IDS)[number];
export declare const CONNECTOR_KINDS: readonly ["erp", "crm", "hris", "accounting", "api", "database", "document"];
export type ConnectorKind = (typeof CONNECTOR_KINDS)[number];
export declare const CONNECTOR_STATUSES: readonly ["draft", "active", "suspended", "archived"];
export type ConnectorStatus = (typeof CONNECTOR_STATUSES)[number];
export declare const DEFAULT_EVENT_TYPES: ReadonlyArray<{
    type_id: string;
