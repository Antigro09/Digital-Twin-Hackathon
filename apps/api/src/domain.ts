...
export const ASTER_TENANT_ID = '10000000-0000-4000-8000-000000000001';
export const BEACON_TENANT_ID = '10000000-0000-4000-8000-000000000002';
export const ASTER_JIRA_INSTALLATION_ID = '30000000-0000-4000-8000-000000000001';
export const AST_142_WORK_ITEM_ID = '116ab4b3-b108-5f91-ab7e-111f7fba1d45';
...
export function etag(hash: string): string {
  return `"sha256:${hash}"`;
}

export function nowIso(): string {
  return process.env.EDT_FROZEN_CLOCK === 'true' ? FROZEN_NOW : new Date().toISOString();
}
