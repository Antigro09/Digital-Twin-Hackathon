...
const enterpriseAnalysts = [
  ...
  { name: "Marketing Analyst", purpose: "Aggregate campaign value, funnel behavior, market trends, marketing risk and budget opportunities", tools: "Graph read · marketing calculations · scenario proposals", permissions: "ai.run.marketing · graph.read.marketing", memory: "Session + validated tenant", skills: "Campaign performance · segment behavior · budget optimization · reality check", loops: "Daily predictions · weekly inefficiencies · monthly forecasts" },
];
