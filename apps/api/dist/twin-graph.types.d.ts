export declare const TWIN_GRAPH_SCHEMA_VERSION = "edt.twin-graph/1.0.0";
export declare const CLASSIFICATIONS: readonly ["public", "internal", "confidential", "restricted"];
export type TwinClassification = (typeof CLASSIFICATIONS)[number];
export declare const NODE_STATES: readonly ["active", "archived"];
export type TwinNodeState = (typeof NODE_STATES)[number];
export declare const RELATIONSHIP_STATES: readonly ["active", "archived"];
